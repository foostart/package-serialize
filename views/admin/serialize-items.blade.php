        ...
        <div class="col-md-9">
            ...
            <div class="panel panel-info">
                ...
                <div class='panel-info panel-description'>
                    ...
                    @if($is_admin)
                        <p>You are admin, <a href="{!! Url::route('serialize.list',['user_id' => $user_id]) !!}">click here</a> to view your created rules
                    @endif
                </div>
                <!--/DESCRIPTION-->
            ...
            <!--/ERRORS-->
                ...
                <div class="panel-body">
                    {!! Form::open(['route'=>['serialize.delete', 'id' => @$item->id], 'method' => 'get'])  !!}
